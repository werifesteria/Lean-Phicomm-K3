...
wget -nv https://raw.githubusercontent.com/garypang13/openwrt-packages/master/smartdns/Makefile -P package/lean/smartdns
wget -nv https://raw.githubusercontent.com/garypang13/openwrt-packages/master/v2ray/Makefile -P package/lean/v2ray
